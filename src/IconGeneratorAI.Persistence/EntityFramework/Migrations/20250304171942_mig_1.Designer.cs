...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("IconGeneratorAI.Domain.Entities.AIModelParameter", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
                    ...
                    b.HasKey("Id")
                        .HasName("pk_ai_model_parameters");

                    b.HasIndex("AIModelId")
                        .HasDatabaseName("ix_ai_model_parameters_ai_model_id");

                    b.HasIndex("PossibleValues")
                        .HasDatabaseName("ix_ai_model_parameters_possible_values");

                    NpgsqlIndexBuilderExtensions.HasMethod(b.HasIndex("PossibleValues"), "GIN");

                    b.ToTable("ai_model_parameters", (string)null);
                });
            ...
            modelBuilder.Entity("IconGeneratorAI.Domain.Entities.IconGenerationParameter", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");

                    b.Property<Guid>("AIModelParameterId")
                        .HasColumnType("uuid")
                        .HasColumnName("ai_model_parameter_id");
                    ...
                    b.Property<Guid>("IconGenerationId")
                        .HasColumnType("uuid")
                        .HasColumnName("icon_generation_id");
                    ...
                    b.HasKey("Id")
                        .HasName("pk_icon_generation_parameters");

                    b.HasIndex("AIModelParameterId")
                        .HasDatabaseName("ix_icon_generation_parameters_ai_model_parameter_id");

                    b.HasIndex("IconGenerationId")
                        .HasDatabaseName("ix_icon_generation_parameters_icon_generation_id");

                    b.ToTable("icon_generation_parameters", (string)null);
                });
            ...
            modelBuilder.Entity("IconGeneratorAI.Domain.Entities.AIModelParameter", b =>
                {
                    b.HasOne("IconGeneratorAI.Domain.Entities.AIModel", "AIModel")
                        ...
                        .IsRequired()
                        .HasConstraintName("fk_ai_model_parameters_ai_models_ai_model_id");
            ...
            modelBuilder.Entity("IconGeneratorAI.Domain.Entities.IconGenerationParameter", b =>
                {
                    b.HasOne("IconGeneratorAI.Domain.Entities.AIModelParameter", "AIModelParameter")
                        .WithMany("IconGenerationParameters")
                        .HasForeignKey("AIModelParameterId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
                        .HasConstraintName("fk_icon_generation_parameters_ai_model_parameters_ai_model_par");

                    b.HasOne("IconGeneratorAI.Domain.Entities.IconGeneration", "IconGeneration")
                        .WithMany("Parameters")
                        .HasForeignKey("IconGenerationId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_icon_generation_parameters_icon_generations_icon_generation");

                    b.Navigation("AIModelParameter");

                    b.Navigation("IconGeneration");
                });
            ...
            modelBuilder.Entity("IconGeneratorAI.Domain.Entities.AIModelParameter", b =>
                {
                    b.Navigation("IconGenerationParameters");
                });
